...
// Class to read and buffer the bytes from a PS/2 interface
class PS2Interface {
public:
  ...
  // Returns the next data byte received from the keyboard or 0 if there is none.
  uint8_t getDataByte();
